...
import downloader
import sys
from Get_image_keyword import My_Google
...
def main(argv):
    ...
    parser.add_argument("--inputpath", "-i", type=str, help='image_input_path.', default=".\download_images\普京.jfif")
    ...
    parser.add_argument("--max-number", "-n", type=int, default=50,
    ...
    if args.proxy_http is not None:
        proxy_type = "http"  #proxy_type = none
        proxy = args.proxy_http #proxy = none
    ...
    if len(args.keywords) > 0:
        ...
        img_url = google.search(args.inputpath)
    print("------begin crawling-------")
    crawled_urls = crawler.crawl_image_urls(img_url, args.keywords,
    ...
    print("---crawl finished,begin downloading---")
